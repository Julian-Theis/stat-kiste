...
if __name__ == "__main__":
    ...
    parser.add_argument('--function', choices=["ci_auc"], help='Available functions: [ci_auc]', required=True)
    ...
    if args.function == "ci_auc":
        if args.file == "":
            ...
            ci_auc(file=args.file, y_pred_col=args.y_pred_col, y_true_col=args.y_true_col, alpha=float(args.alpha))